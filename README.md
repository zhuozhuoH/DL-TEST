# Awesome SE4AI [![Awesome](https://awesome.re/badge.svg)](https://awesome.re)

### ICSE
- [Adversarial Sample Detection for Deep Neural Network through Model Mutation Testing, 2019](https://dl.acm.org/doi/10.1109/ICSE.2019.00126)
- [Guiding Deep Learning System Testing using Surprise Adequacy, 2019](https://dl.acm.org/doi/10.1109/icse.2019.00108)
- [Fuzz Testing based Data Augmentation to Improve Robustness of Deep Neural Networks, 2020](https://ieeexplore.ieee.org/document/9283925)
- [Importance-Driven Deep Learning System Testing, 2020](https://dl.acm.org/doi/10.1145/3377811.3380391)
- [RobOT: Robustness-Oriented Testing for Deep  Learning Systems, 2021](https://dl.acm.org/doi/10.1109/ICSE43902.2021.00038)
- [Prioritizing Test Inputs for Deep Neural Networks via Mutation Analysis, 2021](https://dl.acm.org/doi/10.1109/ICSE43902.2021.00046)
- [DeepLocalize: Fault Localization for Deep Neural Networks, 2021](https://dl.acm.org/doi/10.1109/ICSE43902.2021.00034)
- [Scalable Quantitative Verification For Deep Neural Networks, 2021](https://dl.acm.org/doi/10.1109/icse43902.2021.00039)
- [Distribution-Aware Testing of Neural Networks Using Generative Models, 2021](https://dl.acm.org/doi/10.1109/ICSE43902.2021.00032)
- [Adaptive Test Selection for Deep Neural Networks, 2022](https://dl.acm.org/doi/10.1145/3510003.3510232)
- [DeepState: Selecting Test Suites to Enhance the Robustness of Recurrent Neural Networks, 2022](https://ieeexplore.ieee.org/document/9794081)
- [When and Why Test Generators for Deep Learning Produce Invalid Inputs: an Empirical Study, 2023](https://dl.acm.org/doi/10.1109/ICSE48619.2023.00104)
- [Revisiting Neuron Coverage for DNN Testing: A Layer-Wise and Distribution-Aware Criterion, 2023](https://dl.acm.org/doi/abs/10.1109/ICSE48619.2023.00107)
- [CC: Causality-Aware Coverage Criterion for Deep Neural Networks, 2023](https://ieeexplore.ieee.org/document/10172609)
- [Aries: Efficient Testing of Deep Neural Networks via Labeling-Free Accuracy Estimation, 2023](https://dl.acm.org/doi/abs/10.1109/ICSE48619.2023.00152)
- [CIT4DNN: Generating Diverse and Rare Inputs for Neural Networks Using Latent Space Combinatorial Testing, 2024](https://dl.acm.org/doi/10.1145/3597503.3639106)
- [DeepSample: DNN sampling-based testing for operational accuracy assessment, 2024](https://dl.acm.org/doi/10.1145/3597503.3639584)

  
### ESEC/FSE
- [DLFuzz: Differential Fuzzing Testing of Deep Learning Systems, 2018](https://dl.acm.org/doi/10.1145/3236024.3264835)
- [Dynamic slicing for deep neural networks, 2020](https://dl.acm.org/doi/10.1145/3368089.3409676)
- [DeepSearch: A Simple and Effective Blackbox Attack for Deep Neural Networks, 2020](https://dl.acm.org/doi/10.1145/3368089.3409750)
- [Model-Based Exploration of the Frontier of Behaviours for Deep Learning System Testing, 2020](https://dl.acm.org/doi/10.1145/3368089.3409730)
- [Correlations between Deep Neural Network Model Coverage Criteria and Model Quality, 2020](https://dl.acm.org/doi/abs/10.1145/3368089.3409671)
- [Is neuron coverage a meaningful measure for testing deep neural networks?, 2020](https://dl.acm.org/doi/10.1145/3368089.3409754)
- [Dynamic Data Fault Localization for Deep Neural Networks, 2023](https://dl.acm.org/doi/10.1145/3611643.3616345)
- [DeepRover: A Query-efficient Blackbox Attack for Deep Neural Networks, 2023](https://dl.acm.org/doi/10.1145/3611643.3616370)
- [DistXplore: Distribution-guided Testing for Evaluating and Enhancing Deep Learning Systems, 2023](https://dl.acm.org/doi/10.1145/3611643.3616266)
- [CrossCert: A Cross-Checking Detection Approach to Patch Robustness Certification for Deep Learning Models, 2024](https://dl.acm.org/doi/10.1145/3660827)

### ASE
- [Apricot: A Weight-Adaptation Approach to Fixing Deep Learning Models, 2019](https://ieeexplore.ieee.org/document/8952197)
- [Cats Are Not Fish: Deep Learning Testing Calls for Out-Of-Distribution Awareness, 2020](https://dl.acm.org/doi/10.1145/3324884.3416609)
- [Boosting the Revealing of Detected Violations in Deep Learning Testing: A Diversity-Guided Method, 2022](https://dl.acm.org/doi/10.1145/3551349.3556919)
- [Toward Improving the Robustness of Deep Learning Models via Model Transformation, 2022](https://dl.acm.org/doi/10.1145/3551349.3556920)
- [Unveiling Hidden DNN Defects with Decision-Based Metamorphic Testing, 2022](https://dl.acm.org/doi/abs/10.1145/3551349.3561157)
